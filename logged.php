...
<head>
    ...
    <meta name="author" content="RuiFarinha">
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" href="perfil.php">Histórico</a>
                </li>
                <li class="nav-item">
        ...
        <div class="row h-100">
            <div class="col-lg-7 my-auto">
                <div class="header-content mx-auto">
                    <h1 class="mb-5">A era das encomendas rápidas e eficazes chegou com a Swami!</h1>
                    <a href="#login" class="btn btn-outline btn-xl js-scroll-trigger">Começe Agora</a>
                </div>
            </div>
...
<section class="about bg-light text-center" id="about">
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-4">
                <h3 style="color:#b22222"><b>Visão</b></h3><p></p>
            ...
            <div class="col-sm-4">
                <h3 style="color:#b22222"><b>Missão</b></h3><p></p>
            ...
            <div class="col-sm-4">
                <h3 style="color:#b22222"><b>Valores</b></h3><p></p>
                <h7 align="center">»»»  Fiabilidade</h7><p></p>
                <h7 align="center">»»»  Diversidade</h7><p></p>
                <h7 align="center">»»»  Flexibilidade</h7><p></p>
            </div>
        </div>
    </div>
